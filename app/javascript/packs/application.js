...
import { userBookingsSearch, islandBookingsSearch, islandNameSearch } from '../plugins/bookings_research';
...
document.addEventListener('turbolinks:load', () => {
  ...
  islandBookingsSearch();

  islandNameSearch();

  if (window.location.href == "https://rentanisland.herokuapp.com/") {
    (function() {
      "use strict";
      ...
      function resize() {
          width = Math.max(window.innerWidth * .20, 250),
